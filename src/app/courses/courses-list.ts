...
export const c1: Course = new BasicCourse({
    id: 1,
...
export const c2: Course = new BasicCourse({
    id: 2,
...
export const c3: Course = new BasicCourse({
    id: 3,
...
export const c4: Course = new BasicCourse({
    id: 4,
...
export const c5: Course = new BasicCourse({
    id: 5,
...
export const c6: Course = new BasicCourse({
    id: 6,
...
export const c7: Course = new BasicCourse({
    id: 7,
...
export const c8: Course = new BasicCourse({
    id: 8,
